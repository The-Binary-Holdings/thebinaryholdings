...
const AboutSection = () => {
  return (
    <section
      id="about"
      className="w-full flex justify-center md:pt-64 flex-col items-center relative"
    >
      <div className="inline-table w-0 flex-col items-center text-start md:text-center space-y-20 z-10 translate-y-10">
        ...
        <div className="flex text-white flex-col md:flex-row w-auto text-start justify-between space-y-10 md:space-y-0">
          <VariantsComponent startDistance={100} className="w-full md:w-2/5">
            <p className="">
